...
func TestCompleteMultipartUpload(s *S3Conf) {
	...
	CompleteMultipartUpload_unnecessary_checksum_part(s)
...
func GetIntTests() IntTests {
	return IntTests{
		...
		"UploadPart_required_checksum":                                         UploadPart_required_checksum,
		"UploadPart_null_checksum":                                             UploadPart_null_checksum,
		...
		"CompleteMultipartUpload_unnecessary_checksum_part":                    CompleteMultipartUpload_unnecessary_checksum_part,
		...
		"CompleteMultipartUpload_should_calculate_the_final_checksum":          CompleteMultipartUpload_should_calculate_the_final_checksum,
