...
func TestIAMAssumeRoleWithWebIdentity(ts *TestState) {
	...
	ts.Run(IAMAssumeRoleWithWebIdentity_malformed_duration)
	ts.Run(IAMAssumeRoleWithWebIdentity_wrong_version_is_invalid_action)
	ts.Run(IAMAssumeRoleWithWebIdentity_malformed_token)
	ts.Run(IAMAssumeRoleWithWebIdentity_duration_exceeds_role_max)
	ts.Run(IAMAssumeRoleWithWebIdentity_nonexistent_role)
	ts.Run(IAMAssumeRoleWithWebIdentity_no_matching_principal)
	ts.Run(IAMAssumeRoleWithWebIdentity_no_issuer_match)
	ts.Run(IAMAssumeRoleWithWebIdentity_condition_failed)
	ts.Run(IAMAssumeRoleWithWebIdentity_explicit_deny)
	ts.Run(IAMAssumeRoleWithWebIdentity_audience_not_in_client_id_list)
	ts.Run(IAMAssumeRoleWithWebIdentity_empty_client_id_list)
	ts.Run(IAMAssumeRoleWithWebIdentity_idp_communication_error)
	ts.Run(IAMAssumeRoleWithWebIdentity_role_arn_path_mismatch)
	ts.Run(IAMAssumeRoleWithWebIdentity_policy_arns_rejected)
	ts.Run(IAMAssumeRoleWithWebIdentity_provider_id_rejected)
	ts.Run(IAMAssumeRoleWithWebIdentity_session_policy_too_large)
	ts.Run(IAMAssumeRoleWithWebIdentity_session_policy_invalid)
	ts.Run(IAMAssumeRoleWithWebIdentity_oaud_condition_matches)
...
func TestIAMGetCallerIdentity(ts *TestState) {
	ts.Run(IAMGetCallerIdentity_root_success)
	ts.Run(IAMGetCallerIdentity_user_success)
	ts.Run(IAMGetCallerIdentity_unknown_access_key)
	ts.Run(IAMGetCallerIdentity_no_auth)
	ts.Run(IAMGetCallerIdentity_wrong_version_is_invalid_action)
	ts.Run(IAMGetCallerIdentity_incorrect_service_scope)
}

func TestIAMAccessControl(ts *TestState) {
	ts.Run(IAMAccessControl_ImplicitDenyNoMatchingPolicy)
	ts.Run(IAMAccessControl_AllowGrantsMatchingRequest)
	ts.Run(IAMAccessControl_NonMatchingStatementDoesNotGrant)
	ts.Run(IAMAccessControl_ExplicitDenyOverridesAllow)
	ts.Run(IAMAccessControl_MultipleStatementsEvaluatedIndependently)
	ts.Run(IAMAccessControl_MultipleInlinePoliciesCombinedAllow)
	ts.Run(IAMAccessControl_MultipleInlinePoliciesExplicitDenyWins)
	ts.Run(IAMAccessControl_EffectNonMatchingAllowStillImplicitlyDenies)
	ts.Run(IAMAccessControl_EffectNonMatchingDenyDoesNotBlockUnrelatedAllow)
	ts.Run(IAMAccessControl_ActionMatchingVariants)
	ts.Run(IAMAccessControl_ActionAllowOneDenyAnotherByOmission)
	ts.Run(IAMAccessControl_ActionExplicitDenySubsetOfWildcardAllow)
	...
	ts.Run(IAMAccessControl_ResourceMatchingVariants)
	ts.Run(IAMAccessControl_ResourceOneAllowedOneDeniedSameAction)
	ts.Run(IAMAccessControl_ResourceWildcardRequiredForListAction)
	ts.Run(IAMAccessControl_ResourceExplicitDenyOverridesBroaderAllow)
	ts.Run(IAMAccessControl_NotResourceExcludesTarget)
	ts.Run(IAMAccessControl_NotResourceMultipleExcludedResources)
	ts.Run(IAMAccessControl_NotResourceWildcardExclusion)
	ts.Run(IAMAccessControl_ConditionStringOperators)
	ts.Run(IAMAccessControl_ConditionStringMultipleExpectedValuesOR)
	ts.Run(IAMAccessControl_ConditionArnOperators)
	ts.Run(IAMAccessControl_ConditionIpAddressRealSourceIp)
	ts.Run(IAMAccessControl_ConditionIpAddressExplicitDenyOverridesBroaderAllow)
	ts.Run(IAMAccessControl_ConditionMultipleContextKeysANDed)
	ts.Run(IAMAccessControl_ConditionAllowMatchesDenyConditionDoesNotApply)
	ts.Run(IAMAccessControl_ConditionAllowAndDenyBothMatchDenyWins)
	ts.Run(IAMAccessControl_ConditionOneFailedConditionVoidsStatement)
	ts.Run(IAMAccessControl_ConditionNullPrincipalTag)
	ts.Run(IAMAccessControl_ConditionIfExistsPrincipalTag)
	ts.Run(IAMAccessControl_ConditionResourceTagOnTarget)
	ts.Run(IAMAccessControl_ConditionRequestTagOnCreateUser)
	ts.Run(IAMAccessControl_ConditionCurrentTimeBroadWindow)
	ts.Run(IAMAccessControl_ConditionNumericOperators)
	ts.Run(IAMAccessControl_ConditionDateOperators)
	ts.Run(IAMAccessControl_ConditionBoolOperator)
	ts.Run(IAMAccessControl_ConditionNullOperatorClaim)
	ts.Run(IAMAccessControl_ConditionBinaryEqualsOperator)
	ts.Run(IAMAccessControl_ConditionForAnyValueOperator)
	ts.Run(IAMAccessControl_ConditionForAllValuesOperator)
	ts.Run(IAMAccessControl_ConditionIfExistsTrustClaim)
	ts.Run(IAMAccessControl_ConditionMultipleOperatorBlocksANDedTrust)
	ts.Run(IAMAccessControl_TrustPolicyFederatedExactMatchAllowed)
	ts.Run(IAMAccessControl_TrustPolicyFederatedWrongProviderDenied)
	ts.Run(IAMAccessControl_TrustPolicyFederatedArrayMatchesAny)
	...
	ts.Run(IAMAccessControl_TrustPolicyStringLikeTagSubjectDenied)
	ts.Run(IAMAccessControl_TrustPolicyAudienceCorrectAllowed)
	ts.Run(IAMAccessControl_TrustPolicyAudienceIncorrectDenied)
	ts.Run(IAMAccessControl_TrustPolicyMultipleAudiencesArrayAllowed)
	ts.Run(IAMAccessControl_TrustPolicyAudienceAndSubjectBothMustMatch)
	ts.Run(IAMAccessControl_TrustPolicyExplicitDenyStatement)
	ts.Run(IAMAccessControl_TrustPolicyMultipleStatementsSecondGrants)
	ts.Run(IAMAccessControl_TrustPolicyMissingRequiredClaimDenied)
	ts.Run(IAMAccessControl_UserInlinePolicyWorkflow)
	ts.Run(IAMAccessControl_UserPathScopedResourceGrantsOnlyMatchingPath)
	ts.Run(IAMAccessControl_RolePermissionPolicyDoesNotAffectAssumptionDecision)
	ts.Run(IAMAccessControl_RoleTrustDenialIndependentOfPermissionPolicy)
	ts.Run(IAMAccessControl_CrossIdentity_UnrelatedRoleCannotBeAssumedViaWrongIssuer)
...
func GetIntTests() IntTests {
	return IntTests{
		...
		"IAMAssumeRoleWithWebIdentity_malformed_token":                                     IAMAssumeRoleWithWebIdentity_malformed_token,
		"IAMAssumeRoleWithWebIdentity_duration_exceeds_role_max":                           IAMAssumeRoleWithWebIdentity_duration_exceeds_role_max,
		"IAMAssumeRoleWithWebIdentity_nonexistent_role":                                    IAMAssumeRoleWithWebIdentity_nonexistent_role,
		"IAMAssumeRoleWithWebIdentity_no_matching_principal":                               IAMAssumeRoleWithWebIdentity_no_matching_principal,
		"IAMAssumeRoleWithWebIdentity_no_issuer_match":                                     IAMAssumeRoleWithWebIdentity_no_issuer_match,
		"IAMAssumeRoleWithWebIdentity_condition_failed":                                    IAMAssumeRoleWithWebIdentity_condition_failed,
		"IAMAssumeRoleWithWebIdentity_explicit_deny":                                       IAMAssumeRoleWithWebIdentity_explicit_deny,
		"IAMAssumeRoleWithWebIdentity_audience_not_in_client_id_list":                      IAMAssumeRoleWithWebIdentity_audience_not_in_client_id_list,
		"IAMAssumeRoleWithWebIdentity_empty_client_id_list":                                IAMAssumeRoleWithWebIdentity_empty_client_id_list,
		"IAMAssumeRoleWithWebIdentity_idp_communication_error":                             IAMAssumeRoleWithWebIdentity_idp_communication_error,
		"IAMAssumeRoleWithWebIdentity_role_arn_path_mismatch":                              IAMAssumeRoleWithWebIdentity_role_arn_path_mismatch,
		"IAMAssumeRoleWithWebIdentity_policy_arns_rejected":                                IAMAssumeRoleWithWebIdentity_policy_arns_rejected,
		"IAMAssumeRoleWithWebIdentity_provider_id_rejected":                                IAMAssumeRoleWithWebIdentity_provider_id_rejected,
		"IAMAssumeRoleWithWebIdentity_session_policy_too_large":                            IAMAssumeRoleWithWebIdentity_session_policy_too_large,
		"IAMAssumeRoleWithWebIdentity_session_policy_invalid":                              IAMAssumeRoleWithWebIdentity_session_policy_invalid,
		"IAMAssumeRoleWithWebIdentity_oaud_condition_matches":                              IAMAssumeRoleWithWebIdentity_oaud_condition_matches,
		...
		"IAMGetCallerIdentity_no_auth":                                                     IAMGetCallerIdentity_no_auth,
		"IAMGetCallerIdentity_wrong_version_is_invalid_action":                             IAMGetCallerIdentity_wrong_version_is_invalid_action,
		"IAMGetCallerIdentity_incorrect_service_scope":                                     IAMGetCallerIdentity_incorrect_service_scope,
		"IAMAccessControl_ImplicitDenyNoMatchingPolicy":                                    IAMAccessControl_ImplicitDenyNoMatchingPolicy,
		"IAMAccessControl_AllowGrantsMatchingRequest":                                      IAMAccessControl_AllowGrantsMatchingRequest,
		"IAMAccessControl_NonMatchingStatementDoesNotGrant":                                IAMAccessControl_NonMatchingStatementDoesNotGrant,
		"IAMAccessControl_ExplicitDenyOverridesAllow":                                      IAMAccessControl_ExplicitDenyOverridesAllow,
		"IAMAccessControl_MultipleStatementsEvaluatedIndependently":                        IAMAccessControl_MultipleStatementsEvaluatedIndependently,
		"IAMAccessControl_MultipleInlinePoliciesCombinedAllow":                             IAMAccessControl_MultipleInlinePoliciesCombinedAllow,
		"IAMAccessControl_MultipleInlinePoliciesExplicitDenyWins":                          IAMAccessControl_MultipleInlinePoliciesExplicitDenyWins,
		"IAMAccessControl_EffectNonMatchingAllowStillImplicitlyDenies":                     IAMAccessControl_EffectNonMatchingAllowStillImplicitlyDenies,
		...
		"IAMAccessControl_NotActionAllowGrantsEverythingExceptExcluded":                    IAMAccessControl_NotActionAllowGrantsEverythingExceptExcluded,
		"IAMAccessControl_NotActionDenyBlocksEverythingExceptExcluded":                     IAMAccessControl_NotActionDenyBlocksEverythingExceptExcluded,
		"IAMAccessControl_ResourceMatchingVariants":                                        IAMAccessControl_ResourceMatchingVariants,
		"IAMAccessControl_ResourceOneAllowedOneDeniedSameAction":                           IAMAccessControl_ResourceOneAllowedOneDeniedSameAction,
		"IAMAccessControl_ResourceWildcardRequiredForListAction":                           IAMAccessControl_ResourceWildcardRequiredForListAction,
		"IAMAccessControl_ResourceExplicitDenyOverridesBroaderAllow":                       IAMAccessControl_ResourceExplicitDenyOverridesBroaderAllow,
		"IAMAccessControl_NotResourceExcludesTarget":                                       IAMAccessControl_NotResourceExcludesTarget,
		"IAMAccessControl_NotResourceMultipleExcludedResources":                            IAMAccessControl_NotResourceMultipleExcludedResources,
		"IAMAccessControl_NotResourceWildcardExclusion":                                    IAMAccessControl_NotResourceWildcardExclusion,
		"IAMAccessControl_ConditionStringOperators":                                        IAMAccessControl_ConditionStringOperators,
		"IAMAccessControl_ConditionStringMultipleExpectedValuesOR":                         IAMAccessControl_ConditionStringMultipleExpectedValuesOR,
		"IAMAccessControl_ConditionArnOperators":                                           IAMAccessControl_ConditionArnOperators,
		"IAMAccessControl_ConditionIpAddressRealSourceIp":                                  IAMAccessControl_ConditionIpAddressRealSourceIp,
		"IAMAccessControl_ConditionIpAddressExplicitDenyOverridesBroaderAllow":             IAMAccessControl_ConditionIpAddressExplicitDenyOverridesBroaderAllow,
		"IAMAccessControl_ConditionMultipleContextKeysANDed":                               IAMAccessControl_ConditionMultipleContextKeysANDed,
		...
		"IAMAccessControl_ConditionAllowAndDenyBothMatchDenyWins":                          IAMAccessControl_ConditionAllowAndDenyBothMatchDenyWins,
		"IAMAccessControl_ConditionOneFailedConditionVoidsStatement":                       IAMAccessControl_ConditionOneFailedConditionVoidsStatement,
		"IAMAccessControl_ConditionNullPrincipalTag":                                       IAMAccessControl_ConditionNullPrincipalTag,
		"IAMAccessControl_ConditionIfExistsPrincipalTag":                                   IAMAccessControl_ConditionIfExistsPrincipalTag,
		"IAMAccessControl_ConditionResourceTagOnTarget":                                    IAMAccessControl_ConditionResourceTagOnTarget,
		"IAMAccessControl_ConditionRequestTagOnCreateUser":                                 IAMAccessControl_ConditionRequestTagOnCreateUser,
		"IAMAccessControl_ConditionCurrentTimeBroadWindow":                                 IAMAccessControl_ConditionCurrentTimeBroadWindow,
		"IAMAccessControl_ConditionNumericOperators":                                       IAMAccessControl_ConditionNumericOperators,
		"IAMAccessControl_ConditionDateOperators":                                          IAMAccessControl_ConditionDateOperators,
		"IAMAccessControl_ConditionBoolOperator":                                           IAMAccessControl_ConditionBoolOperator,
		"IAMAccessControl_ConditionNullOperatorClaim":                                      IAMAccessControl_ConditionNullOperatorClaim,
		"IAMAccessControl_ConditionBinaryEqualsOperator":                                   IAMAccessControl_ConditionBinaryEqualsOperator,
		"IAMAccessControl_ConditionForAnyValueOperator":                                    IAMAccessControl_ConditionForAnyValueOperator,
		"IAMAccessControl_ConditionForAllValuesOperator":                                   IAMAccessControl_ConditionForAllValuesOperator,
		"IAMAccessControl_ConditionIfExistsTrustClaim":                                     IAMAccessControl_ConditionIfExistsTrustClaim,
		"IAMAccessControl_ConditionMultipleOperatorBlocksANDedTrust":                       IAMAccessControl_ConditionMultipleOperatorBlocksANDedTrust,
		"IAMAccessControl_TrustPolicyFederatedExactMatchAllowed":                           IAMAccessControl_TrustPolicyFederatedExactMatchAllowed,
		...
		"IAMAccessControl_TrustPolicyNonFederatedPrincipalsIgnored":                        IAMAccessControl_TrustPolicyNonFederatedPrincipalsIgnored,
		"IAMAccessControl_TrustPolicyStringEqualsSubjectExactAllowed":                      IAMAccessControl_TrustPolicyStringEqualsSubjectExactAllowed,
		"IAMAccessControl_TrustPolicyStringEqualsSubjectMismatchDenied":                    IAMAccessControl_TrustPolicyStringEqualsSubjectMismatchDenied,
		"IAMAccessControl_TrustPolicyStringLikeBranchWildcardAllowed":                      IAMAccessControl_TrustPolicyStringLikeBranchWildcardAllowed,
		"IAMAccessControl_TrustPolicyStringLikeTagSubjectDenied":                           IAMAccessControl_TrustPolicyStringLikeTagSubjectDenied,
		"IAMAccessControl_TrustPolicyAudienceCorrectAllowed":                               IAMAccessControl_TrustPolicyAudienceCorrectAllowed,
		"IAMAccessControl_TrustPolicyAudienceIncorrectDenied":                              IAMAccessControl_TrustPolicyAudienceIncorrectDenied,
		"IAMAccessControl_TrustPolicyMultipleAudiencesArrayAllowed":                        IAMAccessControl_TrustPolicyMultipleAudiencesArrayAllowed,
		"IAMAccessControl_TrustPolicyAudienceAndSubjectBothMustMatch":                      IAMAccessControl_TrustPolicyAudienceAndSubjectBothMustMatch,
		"IAMAccessControl_TrustPolicyExplicitDenyStatement":                                IAMAccessControl_TrustPolicyExplicitDenyStatement,
		"IAMAccessControl_TrustPolicyMultipleStatementsSecondGrants":                       IAMAccessControl_TrustPolicyMultipleStatementsSecondGrants,
		"IAMAccessControl_TrustPolicyMissingRequiredClaimDenied":                           IAMAccessControl_TrustPolicyMissingRequiredClaimDenied,
		"IAMAccessControl_UserInlinePolicyWorkflow":                                        IAMAccessControl_UserInlinePolicyWorkflow,
		"IAMAccessControl_UserPathScopedResourceGrantsOnlyMatchingPath":                    IAMAccessControl_UserPathScopedResourceGrantsOnlyMatchingPath,
		"IAMAccessControl_RolePermissionPolicyDoesNotAffectAssumptionDecision":             IAMAccessControl_RolePermissionPolicyDoesNotAffectAssumptionDecision,
