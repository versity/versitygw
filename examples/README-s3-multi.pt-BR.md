...
### URLs Pré-Assinadas
URLs pré-assinadas funcionam conforme esperado com o tratamento de expiração padrão:
- URLs são validadas com parâmetro `X-Amz-Expires`
- Expiração máxima: 7 dias (604800 segundos)
- URLs expiradas retornam `ErrExpiredPresignRequest`
