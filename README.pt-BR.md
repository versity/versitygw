...
Gere URLs temporárias com expiração controlada pelo cliente:

```bash
# Configure o AWS CLI para usar o gateway
...
# Gerar URL pré-assinada com 5 minutos de validade
aws s3 presign s3://meubucket/arquivo.txt --expires-in 300

# Gerar URL pré-assinada com 24 horas de validade
aws s3 presign s3://meubucket/arquivo.txt --expires-in 86400
```

**Importante:** O tempo de expiração é definido pelo **CLIENTE** ao gerar a URL, não pelo gateway. O gateway valida os limites (1s - 7 dias). Veja [`docker/PRESIGNED-URL-EXPIRATION.md`](docker/PRESIGNED-URL-EXPIRATION.md) para documentação completa.
...
Funcionalidades:
- 🐳 Deploy com comando único
- ⚙️ Configuração via variáveis de ambiente
- 🔐 Credenciais auto-geradas
- 💚 Health checks
- 📊 Limites de recursos

Veja [`docker/README.pt-BR.md`](docker/README.pt-BR.md) para documentação completa do Docker.
...
Veja [`examples/README-s3-multi.pt-BR.md`](examples/README-s3-multi.pt-BR.md) para documentação completa.
  ...
  "backends": [
    {
      ...
      "access": "SUA_CHAVE_ACESSO_R2",
      "secret": "SUA_CHAVE_SECRETA_R2",
      "endpoint": "https://SUA_CONTA_ID.r2.cloudflarestorage.com/bucket-primario",
      "region": "us-east-1"
    },
    {
      "name": "fallback-r2",
      "access": "SUA_CHAVE_ACESSO_R2",
      "secret": "SUA_CHAVE_SECRETA_R2",
      "endpoint": "https://SUA_CONTA_ID.r2.cloudflarestorage.com/bucket-fallback",
      "region": "us-east-1"
    }
  ]
}
